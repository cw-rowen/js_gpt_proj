...
try:
    ...
    for t_idx, trial in enumerate(trials, start=1):
        ...
        row = {
            ...
            "Credibility_EX": results["credibility_EX"]["score"],
            "Credibility_CON": results["credibility_CON"]["score"],
            "Credibility_PEER": results["credibility_PEER"]["score"],
            "Credibility_general": results["credibility_general"]["score"],
            "Preference": results["preference"]["score"],
            "Credibility_EX_RT": results["credibility_EX"]["rt"],
            "Credibility_CON_RT": results["credibility_CON"]["rt"],
            "Credibility_PEER_RT": results["credibility_PEER"]["rt"],
            "Credibility_general_RT": results["credibility_general"]["rt"],
            "Preference_RT": results["preference"]["rt"],
        }
